...
{
    public class Beverage_SoftDrink : IMenuItem
    {
        private int _number;
        public int Number
        {
        ...
        {
            return
                $"Number {_number} Name {_name} Description {_description} Price {_price} Pizza IsVegan {_isVegan} IsOrganic {_isOrganic}";
        }
    }
}
